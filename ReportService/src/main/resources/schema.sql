...
(
    ...
    CONSTRAINT FK_PROTOCOLS_ON_SECTIONS FOREIGN KEY (sections_id) REFERENCES sections (id)
);
...
(
    ...
    CONSTRAINT FK_TABLES_ON_PROTOCOL FOREIGN KEY (protocol_id) REFERENCES protocols (id)
);
...
(
    ...
    CONSTRAINT FK_SUBSECTIONS_ON_TABLES FOREIGN KEY (table_id) REFERENCES tables (id)
);
