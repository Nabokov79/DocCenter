...
import ru.nabokovsg.adminservice.services.LicenseService;
...
public class LicenseController {
    ...
    @GetMapping("/{lisId}")
    public ResponseEntity<LicenseDto> get(@PathVariable @NotNull @Positive @Parameter(description = "Индентификатор лицензии") Long lisId) {
        return ResponseEntity.ok().body(service.get(lisId));
    }
