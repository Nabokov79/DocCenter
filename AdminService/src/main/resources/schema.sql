...
(
    ...
    CONSTRAINT UQ_TANK_PARAMETERS UNIQUE (type_id, orientation, volume),
    CONSTRAINT FK_TANK_PARAMETERS_ON_TYPES FOREIGN KEY (type_id) REFERENCES types (id)
);
...
(
    ...
    CONSTRAINT UQ_STANDARD_NORM_PIPES UNIQUE (type_id, diameter, thickness),
    CONSTRAINT FK_STANDARD_NORM_PIPES_ON_TYPES FOREIGN KEY (type_id) REFERENCES types (id)
);
...
(
    ...
    CONSTRAINT FK_PIPELINE_PASSPORT_ON_TYPES FOREIGN KEY (type_id) REFERENCES types (id),
...
(
    ...
    CONSTRAINT FK_OIL_PIPELINE_PASSPORT_ON_TYPES FOREIGN KEY (type_id) REFERENCES types (id),
...
(
    ...
    CONSTRAINT UQ_FILTERS UNIQUE (type_id, model),
    CONSTRAINT FK_FILTER_ON_TYPES FOREIGN KEY (type_id) REFERENCES filters (id)
);
...
(
    ...
    CONSTRAINT UQ_BOILERS UNIQUE (type_id, model),
    CONSTRAINT FK_BOILERS_ON_TYPES FOREIGN KEY (type_id) REFERENCES types (id)
);
...
(
    ...
    CONSTRAINT UQ_BOILER_PASSPORTS UNIQUE (number, boiler_id, address_id),
...
(
    ...
    CONSTRAINT UQ_WORKS UNIQUE (name)
);
...
(
    ...
    orientation   VARCHAR,
    volume        INTEGER,
    primary_visit BOOLEAN                                 NOT NULL,
    repeat_visit  BOOLEAN                                 NOT NULL,
    note          VARCHAR,
    CONSTRAINT pk_application PRIMARY KEY (id),
    CONSTRAINT UQ_APPLICATIONS UNIQUE (date, address_id, primary_visit),
    CONSTRAINT FK_APPLICATIONS_ON_ADDRESSES FOREIGN KEY (address_id) REFERENCES addresses (id),
    CONSTRAINT FK_APPLICATIONS_ON_TYPES FOREIGN KEY (type_id) REFERENCES types (id),
    CONSTRAINT FK_APPLICATIONS_ON_WORKS FOREIGN KEY (work_id) REFERENCES works (id)
);
...
(
    ...
    user_id        BIGINT,
    CONSTRAINT pk_application_of_users PRIMARY KEY (application_id, user_id)
);
...
(
    ...
    CONSTRAINT FK_REPORTS_DATA_ON_APPLICATIONS FOREIGN KEY (application_id) REFERENCES applications (id),
    CONSTRAINT FK_REPORTS_DATA_ON_USERS FOREIGN KEY (user_id) REFERENCES users (id)
);